...
//BUSCAR POR NOMBRE
function filterName() {
  let findName = valueNameOption.value.toLowerCase();//con nombre valueNameOption aca en findName estamos sacando el valor
  // y lo convertimos en minuscula para que coincida con el de data
  //console.log(valueNameOption);
  let cardArray = element.childNodes;// elementos de cada tarjeta 
